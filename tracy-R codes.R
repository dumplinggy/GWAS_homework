...
GTest(FAMCOV$P, FAMCOV$sex_2male.l2)
table(FAMCOV$P,FAMCOV$HLDprev.l2)
GTest(FAMCOV$P, FAMCOV$HLDprev.l2)
table(FAMCOV$P,FAMCOV$HTNprev.l2)
GTest(FAMCOV$P, FAMCOV$HTNprev.l2)
table(FAMCOV$P,FAMCOV$T1Dprev.l2)
GTest(FAMCOV$P, FAMCOV$T1Dprev.l2)
table(FAMCOV$P,FAMCOV$T2Dprev.l2)
GTest(FAMCOV$P, FAMCOV$T2Dprev.l2)
table(FAMCOV$P,FAMCOV$binSmok.l2)
GTest(FAMCOV$P, FAMCOV$binSmok.l2)
